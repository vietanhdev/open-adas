...
/// \param parser
///
ObjectDetectorWithTracking::ObjectDetectorWithTracking(const cv::CommandLineParser& parser)
    :
      m_showLogs(true),
      m_fps(25),
...
///
/// \brief ObjectDetectorWithTracking::AsyncProcess
///
void ObjectDetectorWithTracking::AsyncProcess()
{
...
///
/// \brief ObjectDetectorWithTracking::CaptureAndDetect
/// \param thisPtr
/// \param stopCapture
///
void ObjectDetectorWithTracking::CaptureAndDetect(ObjectDetectorWithTracking* thisPtr, std::atomic<bool>& stopCapture)
{
...
/// \param regions
///
void ObjectDetectorWithTracking::Detection(cv::Mat frame, regions_t& regions)
{
    regions_t regs;
...
/// \param regions
///
void ObjectDetectorWithTracking::Tracking(cv::Mat frame, const regions_t& regions)
{
 	cv::UMat uframe;
...
///
void ObjectDetectorWithTracking::DrawTrack(cv::Mat frame,
                             int resizeCoeff,
...
///
/// \brief ObjectDetectorWithTracking::OpenCapture
/// \param capture
/// \return
///
bool ObjectDetectorWithTracking::OpenCapture(cv::VideoCapture& capture)
{
    if (m_inFile.size() == 1)
...
///
/// \brief ObjectDetectorWithTracking::WriteFrame
/// \param writer
/// \param frame
/// \return
///
bool ObjectDetectorWithTracking::WriteFrame(cv::VideoWriter& writer, const cv::Mat& frame)
{
    if (!m_outFile.empty())
    {
        if (!writer.isOpened())
